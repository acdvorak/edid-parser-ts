...
const ESTABLISHED_TIMING_BITMAPS = [
  '720×400 @ 70 Hz',
  '720×400 @ 88 Hz',
  '640×480 @ 60 Hz',
  '640×480 @ 67 Hz',
...
const SHORT_VIDEO_DESCRIPTORS: ShortVideoDescriptor[] = [
  { vic: 0 },
  {
    vic: 1,
    format: '640x480p',
 ...
 */
function getEisaId(reader: BlockReader): string {
...
function parseBaseBlock(
  ...
  baseBlock.eisaId = getEisaId(reader);
...
export function parseEdid(
  ...
  const debug: ParsedEdidDebug = {
    tables: {
      whiteAndSyncLevels: [...WHITE_AND_SYNC_LEVELS],
      digitalColorSpace: [...DIGITAL_COLOR_SPACE],
      analogColorSpace: [...ANALOG_COLOR_SPACE],
      establishedTimingBitmaps: [...ESTABLISHED_TIMING_BITMAPS],
      xyPixelRatioEnum: [...XY_PIXEL_RATIO_ENUM],
      syncTypeEnum: { ...SYNC_TYPE_ENUM },
      dataBlockType: { ...DATA_BLOCK_TYPE },
      extendedDataBlockType: { ...EXTENDED_DATA_BLOCK_TYPE },
      ieeeOuiType: { ...IEEE_OUI_TYPE },
      overscanBehavior: [...OVERSCAN_BEHAVIOR],
      audioFormatArray: [...AUDIO_FORMAT_ARRAY],
      shortAudioDescriptors: [...SHORT_AUDIO_DESCRIPTORS],
      sadSampleRates: [...SAD_SAMPLE_RATES],
      sadBitDepths: [...SAD_BIT_DEPTHS],
      eotfTypes: [...EOTF_TYPES],
      staticMetadataDescriptors: [...STATIC_METADATA_DESCRIPTORS],
      shortVideoDescriptors: [...SHORT_VIDEO_DESCRIPTORS],
      speakerAllocation: [...SPEAKER_ALLOCATION],
    },
    legacy: {
      validHeader: baseBlock.headerValidity,
      eisaId: baseBlock.eisaId,
