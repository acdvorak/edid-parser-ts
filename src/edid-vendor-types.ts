...
export interface EdidVendorIdMap {
  AAA: `Avolites`;
...
export type EdidVendorId = keyof EdidVendorIdMap;

export type EdidVendorName = ValueOf<{
  [K in EdidVendorId]: EdidVendorIdMap[K] extends string
    ? EdidVendorIdMap[K]
    : EdidVendorIdMap[K][number];
}>;
